...
bool operator ==(Object other) {
  final _this = this as CounterState;
  return identical(this, other) || (other.runtimeType == runtimeType&&other is CounterState&&(identical(other.counter, _this.counter) || other.counter == _this.counter));
}
...
int get hashCode {
  final _this = this as CounterState;
  return Object.hash(runtimeType,_this.counter);
}

@override
String toString() {
  final _this = this as CounterState;
  return 'CounterState(counter: ${_this.counter})';
}
...
class _CounterState implements CounterState {
  const _CounterState({this.counter = 0});
...
@override
int get hashCode {
    return Object.hash(runtimeType,counter);
}
